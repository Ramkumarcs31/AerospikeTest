...
public class Parameters {
    ...
    public boolean hasCDTList;
    public boolean hasCDTMap;

    public Parameters(TlsPolicy policy, String host, int port, String user, String password, String namespace, String set) {
        this.host = host;
        this.port = port;
        this.user = user;
     ...
     */
    public void setServerSpecific(AerospikeClient client) throws Exception {
